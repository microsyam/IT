...
<head>
    ...
    <title>Open Ticket | <?php echo $userdata[0]['s_name'];?></title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid" >
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Open Ticket</h1>
						<div class="panel panel-default">
                <div class="panel-heading">Ticket Type</div>
                <div class="panel-body">
                    <div class="col-xs-3">
					<?php echo form_open('OpenTicket/Save');?>
                    ...
                    <div class="col-sm-9 nopadding">
                        <div class="form-group">
                            <div class="input-group" style="padding-left:40%">
                                    <textarea type="text" style="width:600px;height:150px" required class="form-control total" name="service_text" placeholder="..." ></textarea>
