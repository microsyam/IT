...
<head>
    ...
    <title>Services | <?php echo $userdata[0]['s_name'];?></title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid" >
                ...
                <div class="panel-heading">Service Data </div>
                <div class="panel-body">
				
                 <div class="form-group">
				 <?php echo form_open('NewService/save');?>
				  <label for="name" class="col-lg-2">Service Name</label>
					<div class="col-lg-3">
					  <input type="text" class="form-control" required name="servicename" id="name">
					  
					</div>
					<div class="col-lg-3">
					  <button type="submit" class="btn btn-primary center-block">Add Service</button>
            ...
            <?php echo form_open('NewService/remove');?>
                <?php foreach($services as $row):?>
                    <?php echo '<tr>'; ?>
                    <?php echo '<td>'.$row->s_name .'</td>';?>
					<td style="width:1px"><button type="submit" name="remove" value="<?php echo $row->s_id;?>" class="btn btn-danger">×</button></td>
                    <?php echo '</tr>'; ?>
                <?php endforeach ; ?>
