...
<head>
    ...
    <title>Warehouses | <?php echo $userdata[0]['s_name'];?></title>
        ...
        <div id="page-wrapper">
            <div class="container-fluid" >
                ...
                <div class="panel-body">
				 ...
				 <?php echo form_open('Warehouses/save');?>
				  <label for="name" class="col-lg-2">Warehouse Name</label>
					<div class="col-lg-3">
					  <input type="text" class="form-control" required name="departmentname" id="name">
					  
					</div>
					<div class="col-lg-3">
					  <button type="submit" class="btn btn-primary center-block">New Warehouse</button>
            ...
            <?php echo form_open('Warehouses/remove');?>
                <?php foreach($services as $row):?>
                    <?php echo '<tr>'; ?>
                    <?php echo '<td>'.$row->w_name .'</td>';?>
					<td style="width:1px"><button type="submit" name="remove" value="<?php echo $row->w_id;?>" class="btn btn-danger">×</button></td>
                    <?php echo '</tr>'; ?>
                <?php endforeach ; ?>
