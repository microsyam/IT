    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid" >
                ...
                <div class="panel-heading">Add a plant </div>
                <div class="panel-body">
				
                 <div class="form-group">
				 <?php echo form_open('Plants/save');?>
				  <label for="name" class="col-lg-2">Plant Name</label>
					<div class="col-lg-3">
					  <input type="text" class="form-control" required name="plantname" id="name">
					  
					</div>
					<div class="col-lg-3">
					  <button type="submit" class="btn btn-primary center-block">New Plant</button>
                ...
                <div class="panel-heading">Current Plants</div>
            ...
            <?php echo form_open('Plants/remove');?>
                <?php foreach($services as $row):?>
                    <?php echo '<tr>'; ?>
                    <?php echo '<td>'.$row->p_name .'</td>';?>
					<td style="width:1px"><button type="submit" name="remove" value="<?php echo $row->p_id;?>" class="btn btn-danger">×</button></td>
                    <?php echo '</tr>'; ?>
                <?php endforeach ; ?>
